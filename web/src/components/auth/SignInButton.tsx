  ...
  return (
    <div>
      <button
        ...
        onClick={signIn}
        disabled={pending}
        className="flex w-full items-center justify-center gap-2.5 rounded-md bg-brand px-4 py-2.5 text-[14px] font-semibold text-[#10120F] transition-colors hover:bg-[#D8FF66] disabled:cursor-not-allowed disabled:opacity-60"
      >
